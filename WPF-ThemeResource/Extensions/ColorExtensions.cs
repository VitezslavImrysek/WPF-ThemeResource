...
namespace WPF_ThemeResource.Extensions
{
    ...
    public static class ColorExtensions
    {
        ...
        )
        {
            ...
            (float hue2, float saturation, float rawLuminance) = Color
                .FromArgb(color.A, ToColorByte(red), ToColorByte(green), ToColorByte(blue))
                .ToHsl();

            (red, green, blue) = FromHslToRgb(hue2, saturation, ToPercentage(rawLuminance + luminanceFactor));
